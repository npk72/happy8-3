(function () {
    ...
    function drawFlowers() {
      ...
      let mode = pick(["daisies", "roses", "crosshatch", "blueYellow", "hydrangea"])    
      let bg = new randomColor(minSat=10)
   
       
      //themes hsl=pistil color hsl2=petal color
      var colorz = {
      "daisies":{h2:12,s2:38,l2:97,h:45,s:92,l:52,vary:10,mix:false},
      "roses":{h:1,s:91,l:46,h2:1,s2:91,l2:30,vary:10,mix:true},
      "crosshatch":{h:1,s:91,l:46,vary:80,mix:true},/*only defines one varying pistil color*/
      "hydrangea":{h:102,s:72,l:27,h2:348,s2:89,l2:42,vary:10,mix:false},
      ...
      //draw the flowers
      let numFlower = mode=="multi"?getRandomInt(70,100) : getRandomInt(40,250)
